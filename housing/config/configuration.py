   # the code to read the config.yaml file.

from housing.entity.config_entity import DataIngestionConfig, DataTransformationConfig, \
    DataValidationConfig, ModelPusherConfig, ModelEvaluationConfig, ModelTrainerConfig, TrainingPipelineConfig
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            data_validation_artifact_dir =  os.path.join(artifact_dir,
                                                        data_validation_info[DATA_VALIDATION_ARTIFACT_DIR_KEY])
